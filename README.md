...
## Project Structure
    ...
    ├── exploratorytest_dev_32602  # Django project configurations
...
1. Clone this repo and `cd exploratorytest_dev_32602`
...
2. Clone this repo and `cd exploratorytest_dev_32602`
